...
const aikey = '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'
...
Youtube Premium 4 bulan *10k*
Youtube Premium 6 bulan *15k* .
          ...
          case 'play':{
            ...
            case 'whatmusic':
                ...
                try {
                    ...
                    //console.log(util.format(anu))
                    let hsl = anu.url
                    const lgu = await fetchJson(`hhttps://api.lolhuman.xyz/api/musicsearch?apikey=ardanfajars&file=${hsl}`)
                    console.log(lgu)
                    let yts = require("yt-search")
